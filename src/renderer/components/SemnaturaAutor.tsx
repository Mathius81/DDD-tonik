...
import type { AboutDiagnostics, AboutInfo, AboutStats } from '../../shared/schemas/about';
...
export function SemnaturaAutor() {
  ...
  useEffect(() => {
    ...
    window.addEventListener(SECRET_MENU_EVENT, deschideMeniul);
    return () => window.removeEventListener(SECRET_MENU_EVENT, deschideMeniul);
  }, []);
